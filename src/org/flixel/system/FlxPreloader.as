package org.flixel.system
{
	...
	public class FlxPreloader extends MovieClip
	{
		...
		[Embed(source = "../../../res/img/bg/houseBG.png")] protected var ImgBG:Class;
		/**
		 * @private
		 */
		...
		private function onEnterFrame(event:Event):void
        {
            ...
            {
                update(1);
                title2.visible = button.visible = true;
                if (Registry.adsDone) {
        ...
        public function turnWhite(e:Event):void {
            
            button.graphics.beginFill(0xFFFFFF);
            button.graphics.drawRect(100, 50, 85, 40);
            button.graphics.endFill();
        
        }
        public function turnBlue(e:Event):void {
            
            button.graphics.beginFill(0x00ddcc);
            button.graphics.drawRect(100, 50, 85, 40);
            button.graphics.endFill();
		...
		protected function create():void
		{
			...
			var bitmapBG:Bitmap = new ImgBG();
			bitmapBG.smoothing = true;
			bitmapBG.width = _height * 1.4;
			bitmapBG.height = _height;
			bitmapBG.x = (_width - bitmapBG.width) / 2;
            
			_buffer.addChild(bitmapBG);
            ...
            button.addEventListener(MouseEvent.MOUSE_OVER, turnWhite);
            button.addEventListener(MouseEvent.MOUSE_OUT, turnBlue);
            
			var title:TextField = new TextField();
			title.defaultTextFormat = new TextFormat("system", 16, 0x5f6aff);
			title.embedFonts = true;
			title.x = 35; title.y = 10; title.width = 1200; title.height = 1200;
			title.text = "INSPIRATION DAVE\r A Flixel game by Seagaia";
           
			
            /* can change this to sponsor splash*/
           ...
           _buffer.addChild(title);
            
               _buffer.addChild(button);	
			title2 = new TextField();
			title2.defaultTextFormat = new TextFormat("system", 16, 0x5f6aff);
			title2.embedFonts = true;
			title2.x = 112; title2.y = 58; title2.width = 55; title2.height = 20;
			title2.text = "PLAY!";
            title2.mouseEnabled = false;
            title2.visible = false;
            button.visible = false;
            _buffer.addChild(title2);
		}
