	...
	public class FlxStarField extends FlxSprite
	{
		...
		private function update2DStarfield():void
		{
			for each (var star:Object in stars)
			{
				...
				starMap.setPixel32(star.x - 1, star.y - 1, depthColours[star.speed - 1]);
				starMap.setPixel32(star.x - 1, star.y, depthColours[star.speed - 1]);
				starMap.setPixel32(star.x, star.y - 1, depthColours[star.speed - 1]);
